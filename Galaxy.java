...
public class Galaxy extends CelestialObject {
	...
	private static final double HUBBLE_CONSTANT = 70; // how far away it's moving is 70km/s/mpc bc universe is
								// expanding
	private static final double SPEED_OF_LIGHT = 299792.458; // km per second

	// CONSTRUCTOR
	public Galaxy(String name, double rightAscension, double declination, double apparentMagnitude, double redshift,
			String galaxyType) {
		super(name, rightAscension, declination, apparentMagnitude,
				galaxyType.equalsIgnoreCase("Spiral") ? new Color(220, 220, 255)
	...
	public String getInfo() {
		...
		info.append("Distance: ").append(String.format("%.2f", calcRedshiftDistance()))
