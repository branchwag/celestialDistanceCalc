...
public class StarFieldPanel extends JPanel {
	...
	public StarFieldPanel(SkyMap skyMap, ObjectInfoPanel infoPanel) {
		...
		// init the background stars after component is shown to prevent issue where
		// background stars would change on click
	...
	protected void paintComponent(Graphics g) {
		...
		// the coordinates need to be drawn BEFORE the objects
		// this resolves an issue I had where the grid lines were previously overlapping
		// the text
	...
	// function to draw the lil background stars for the first timeif not yet drawn
	// or retrieve if drawn already
